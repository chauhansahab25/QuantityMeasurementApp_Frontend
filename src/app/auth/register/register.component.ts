        ...
        <div class="auth-right">
          <div class="auth-card">
            <div class="auth-header">
              ...
              <p>Join us to start converting measurements</p>
            </div>
              ...
              <div class="form-row-2">
                <div class="form-group">
                  ...
                  <div class="input-wrapper">
                    ...
                    <input type="text" class="glass-input" formControlName="firstName" placeholder="John">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-wrapper">
                    <span class="input-icon">👤</span>
                    <input type="text" class="glass-input" formControlName="lastName" placeholder="Doe">
                  </div>
                </div>
              </div>
              <div class="form-group">
